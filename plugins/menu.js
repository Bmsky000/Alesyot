...
floc = await Func.createThumb('https://telegra.ph/file/0acd56d1610d84e416720.jpg')
//===FAKE===
global.ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "0@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": floc},"title": "halo sayang","description": "halo asu","currencyCode": "IDR","priceAmount1000": "400000000","retailerId": "Ghost","productImageCount": 1 },"businessOwnerJid": `0@s.whatsapp.net` }}}        
 ...
 let memi = await client.sendMessageModify(m.chat, Func.Styles(print) + '\n\n' + global.footer, m,{
               ads: true,
               largeThumb: true,
               thumbnail: setting.cover,
              url: setting.link
             })
     //      client.sendPtv(m.chat, `./menu.mp4
                               client.sendMessage(m.chat, {audio: { url: "./menu.mp3" }, seconds: "1", mimetype: "audio/mp4", ptt: true, },{ quoted: memi });
          }    
      } catch (e) {
